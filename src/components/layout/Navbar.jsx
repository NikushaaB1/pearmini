        ...
        <div className="flex items-center gap-4">
          {!user && (
            <button
              ...
              className="px-3 py-1 rounded-md text-sm font-semibold bg-gradient-to-r from-amber-500 to-amber-600 text-white hover:shadow-md"
            >
              შესვლა
            </button>
          )}
          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/') }>
            <PearLogo size="md" animated={false} />
            <div className="hidden sm:block">
              <div className="text-sm font-bold text-[var(--text-primary)]">PEAR Elite</div>
              <div className="text-[10px] text-[var(--text-muted)]">Model Network</div>
            </div>
          </div>
        </div>
